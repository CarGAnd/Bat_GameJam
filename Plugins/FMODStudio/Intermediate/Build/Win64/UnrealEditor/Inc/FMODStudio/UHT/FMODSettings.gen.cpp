...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODProjectLocale>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFMODSettings, UFMODSettings::StaticClass, TEXT("UFMODSettings"), &Z_Registration_Info_UClass_UFMODSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFMODSettings), 2584368052U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_136862608(TEXT("/Script/FMODStudio"),
		Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Nenn_Documents_Unreal_Projects_Bat_GameJam_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo));
